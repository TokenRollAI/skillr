...
export default function NamespaceSettingsPage() {
  ...
  async function loadMembers() {
    try {
      const res = await fetch(`/api/namespaces/${nsName}/members`, { headers });
  ...
  async function addMember(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/namespaces/${nsName}/members`, {
        method: 'POST',
        headers,
  ...
  async function removeMember(userId: string) {
    ...
    try {
      await fetch(`/api/namespaces/${nsName}/members/${userId}`, {
        method: 'DELETE',
        headers,
      });
      loadMembers();
